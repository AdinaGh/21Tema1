...
namespace Tema1Tests
{
    ...
    {
        [TestMethod]
        public void Should_Sub_TwoDouble_Valid_Matrix()
        {
            //Arrange
            ...
            Assert.AreEqual(mult.Elements[0, 0], 2);
            Assert.AreEqual(mult.Elements[1, 0], 3);
        }
        ...
        [TestMethod]
        public void Should_Sub_TwoInt_Valid_Matrix()
        {
            //Arrange
            ...
            Assert.AreEqual(mult.Elements[0, 0], 2);
            Assert.AreEqual(mult.Elements[1, 0], 5);
        }

        [TestMethod]
        public void Should_Sub_TwoFloat_Valid_Matrix()
        {
            //Arrange
